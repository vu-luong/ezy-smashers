...
import com.vuluong.plugin.PluginEntry;
import com.vuluong.plugin.PluginEntryLoader;
import com.vuluong.app.AppEntry;
import com.vuluong.app.AppEntryLoader;

public class ApplicationStartup {
	
	public static final String ZONE_APP_NAME = "EzyTank"; 
		...
		public EzyPluginEntry load() throws Exception {
			return new PluginEntry() {
				...
				private String getPluginPath(EzyPluginSetting setting) {
					Path pluginPath = Paths.get("EzyTank-plugin");
					if(!Files.exists(pluginPath))
						pluginPath = Paths.get("../EzyTank-plugin");
		...
		public EzyAppEntry load() throws Exception {
			return new AppEntry() {
				...
				private String getAppPath() {
					Path pluginPath = Paths.get("EzyTank-app-entry");
					if(!Files.exists(pluginPath))
						pluginPath = Paths.get("../EzyTank-app-entry");
					return pluginPath.toString();
				}
			};
		}
